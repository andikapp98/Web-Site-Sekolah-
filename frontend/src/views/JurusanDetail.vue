    ...
    <main class="detail-main">
      ...
      <section class="cards-section">
        <div class="cards-container">
          <!-- Row 1: Peluang Karir + Kompetensi Lulusan -->
          <div class="cards-row top-row">
            <!-- Peluang Karir Card -->
            <div class="detail-card career-card">
              ...
              <p class="card-text">{{ program.career_opportunities || detailData.career }}</p>
            </div>
            ...
            <div class="detail-card competency-card">
              ...
              <div class="competency-with-image">
